...
public class MoneyPileImageGenerator2 extends JComponent implements MouseListener{

	public static void main(String[] args) {
		MoneyPileImageGenerator2 mpig = new MoneyPileImageGenerator2();
		mpig.generate();
	}
	...
	public void mouseReleased(MouseEvent e) {
		...
		if(x < width / 2) {
			...
			right = 0;
			new Thread(() -> {writeImage(img); img = makeImage();}).start();
		}
	}
